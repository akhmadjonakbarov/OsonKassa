...
import 'package:osonkassa/features/dashboard_views/customer/view/controllers/customer_controller/customer_events.dart';
...
import '../../../logic/customer_repository.dart';
import '../../../logic/customer_services.dart';
...
class CustomerCtl extends PaginationController {
  ...
  Rxn<CustomerEvents> customerEvents = Rxn<CustomerEvents>();
