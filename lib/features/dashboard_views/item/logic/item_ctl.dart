...
import 'package:osonkassa/features/dashboard_views/item/data/repository/product_repository_impl.dart';
import 'package:osonkassa/features/dashboard_views/item/domain/repository/product_repository.dart';
...
class ItemCtl extends MainController<Item> {
  ...
  void addItem(Map<String, dynamic> item) async {
    try {
      ...
      if (isCreated) {
        UserNotifier.snackbar(label: "Item created successfully");
        fetchItems();
      }
