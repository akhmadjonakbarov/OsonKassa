...
import 'package:osonkassa/features/shared/widgets/center_text.dart';
import 'package:osonkassa/features/shared/widgets/custom_data_table.dart';
import 'package:osonkassa/styles/text_styles.dart';
import 'package:osonkassa/translation/translated_texts.dart';
import 'package:osonkassa/utils/formatter_functions/formatter_currency.dart';
...
class PaymentHistoriesBox extends StatelessWidget {
      ...
      child: Obx(
        () {
          ...
          if (customerDetailCtl.isPaymentHistoriesLoading.value) {
            ...
            if (customerDetailCtl.transactions.isNotEmpty) {
              return Padding(
      ...
      children: [
        ...
        SizedBox(
          ...
          child: CustomDataTable(
            ...
            rows: customerDetailCtl.transactions
                .asMap()
                .entries
                .map(
  ...
  DataRow buildDebtRow(int index, Transaction history) {
    return DataRow(
      cells: [
        DataCell(CenterText(text: "${index + 1}")),
        DataCell(
          CenterText(
            text: PriceFormatter.formatPrice(history.amount!),
          ),
        ),
        DataCell(CenterText(
